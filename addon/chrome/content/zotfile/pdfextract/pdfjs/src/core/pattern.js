...
var Pattern = (function PatternClosure() {
  ...
  Pattern.parseShading = function Pattern_parseShading(
    shading,
    matrix,
    xref,
    res,
...
Shadings.RadialAxial = (function RadialAxialClosure() {
  function RadialAxial(dict, matrix, xref, res) {
    ...
    if (
      this.shadingType === PatternType.RADIAL &&
    ...
    while (reader.hasData) {
      ...
      switch (f) {
        ...
        case 1:
          ...
          ps[15] = pi + 2;
          ps[8] = pi + 6;
          /* values for 5, 6, 9, 10 are    */ ps[11] = pi + 1;
          ps[4] = pi + 7;
          /* calculated below              */ ps[7] = pi;
          ps[0] = tmp1;
          ps[1] = tmp2;
          ps[2] = tmp3;
          ps[3] = tmp4;
        ...
        case 2:
          ...
          ps[15] = pi + 5;
          ps[8] = ps[11];
          /* values for 5, 6, 9, 10 are    */ ps[11] = pi + 4;
          ps[4] = ps[7];
          /* calculated below              */ ps[7] = pi + 3;
          ps[0] = ps[3];
          ps[1] = pi;
          ps[2] = pi + 1;
          ps[3] = pi + 2;
